...
| Agent 框架 | SpoonOS (SpoonReact Agent) |
| AI 模型 | OpenAI GPT-4 / Anthropic Claude / Google Gemini |
| 视频生成 | Google Veo 2 MCP / InVideo AI MCP |
| 市场数据 | Polymarket MCP Server |
| 社交分发 | Twitter/X MCP Server |
...
│              MCP 服务层                       │
├───────────┬───────────┬───────────┬─────────┤
│Polymarket │ Video Gen │ Twitter/X │ Others  │
...
使用 Google Veo 2 或其他视频生成 MCP 服务,根据脚本和关键帧描述生成视频。视频参数:
- 格式: 9:16 竖屏
- 分辨率: 1080p
- 时长: 30-60 秒
...
访问 https://invideo.io/ai/mcp/ 获取配置说明
